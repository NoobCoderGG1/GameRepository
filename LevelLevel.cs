...
public partial class LevelLevel : Node2D
{
	...
	private Vector2[] spawn_positions = new Vector2[5] {new Vector2(x: 0,   y: 0), 
														new Vector2(x: 25,  y: -79),
														new Vector2(x: 147, y: -6),
														new Vector2(x: 179, y: -50),
														new Vector2(x: 197, y: -6) };
